...
- Total Dart files scanned: **18**
- Fully documented file headers: **18**
- Missing file headers: **0**
- Total functions/methods scanned: **43**
- Functions/methods with doc comments: **43**
...
- `lib/screens/login_screen.dart` — Handles sign-in providers and guest sign-in entry. _(status: documented)_
...
- `lib/screens/upgrade_account_screen.dart` — Lets anonymous users upgrade to a linked account. _(status: documented)_
- `lib/screens/user_profile_screen.dart` — Displays user profile and saved high-score records. _(status: documented)_
