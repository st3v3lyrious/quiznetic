...
- Total Dart files scanned: **24**
- Fully documented file headers: **24**
- Missing file headers: **0**
- Total functions/methods scanned: **112**
- Functions/methods with doc comments: **112**
...
- `lib/data/capital_loader.dart` — Loads capital-quiz questions from flag assets and capital mappings. _(status: documented)_
...
- `lib/screens/home_screen.dart` — Shows quiz categories, guest upgrade CTA, and routes to difficulty selection. _(status: documented)_
